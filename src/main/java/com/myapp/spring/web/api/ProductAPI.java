...
//    @GetMapping("/find/ByProductNameLike/")
//    public ResponseEntity<List<Product>> findProductsByProductNameLike(
//    		 @RequestParam("productName") Optional<String> productName){
//        return new ResponseEntity<List<Product>>
//        (repository.findProductsByProductNameLike(Optional(productName).get(),HttpStatus.OK));
//    }
    
    @GetMapping("/find/ByProductNameLike/{productName}")
    public ResponseEntity<List<Product>> findByProductNameLike
        (@RequestParam("productName") Optional<String> productName){
...
//    
//  //ass//http://localhost:8888/api/v1/products/findByPriceOrName?productName=Oneplus
//    @GetMapping("/findProductsByProductNameLike")
//    public ResponseEntity<List<Product>> findProductsByProductNameLike
//    (@RequestParam("price") Optional<Double> price,
//            @RequestParam("productName") Optional<String> productName){
//        
...
//	public ResponseEntity<Product> findByProductNameLike(@PathVariable("productName") String productName){
//		
//	return new ResponseEntity<Product>(repository.findByProductNameLike(productName).get(),HttpStatus.OK);
//	}
//		
